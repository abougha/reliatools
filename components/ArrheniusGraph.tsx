  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <p>
        ...
        The <a href="https://www.zvei.org/fileadmin/user_upload/Presse_und_Medien/Publikationen/2013/Oktober/Handbook_for_Robustness_Validation_of_Automotive_Electrical/Robust-Validation-EE-Modules.pdf" 
        target="_blank" 
      ...
      <p>
        Curious how simulate temperature affects? Check out our{" "}
        <Link href="/app/tools/Arrhenius/page.tsx" 
        className="text-blue-600 hover:underline"
        >Arrhenius Calculator</Link> for quick estimates.
      </p>
      ...
      <p>
        ...
        rel="noopener noreferrer"
        className="text-blue-600 hover:underline"
        >NASA Physics of Failure Handbook</a> emphasizes the importance of understanding the underlying failure physics—not just applying the equation blindly.
      </p>
      <p>
        Want to estimate your own burn-in conditions to ensure quality? Try our{" "}
        <Link href="/tools/BurnInWizard" className="text-blue-600 hover:underline">Burn-In Wizard</Link> to simulate equivalent field life from accelerated test plans.
      </p>
