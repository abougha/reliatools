  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10">
      ...
      <p className="text-lg text-gray-700 mb-6">
        Consumer electronics—like smartphones, laptops, and tablets—must withstand frequent power cycles and ambient temperature changes. One of the most critical reliability challenges is <strong>thermal shock</strong>: rapid temperature changes that cause expansion and contraction, leading to material fatigue.
      </p>
      ...
      <p>
        The Coffin-Manson model specifically addresses <strong>low-cycle fatigue</strong>, where materials—particularly solder joints and interfaces—fail due to repeated thermal expansion and contraction.
      </p>
      <p>
